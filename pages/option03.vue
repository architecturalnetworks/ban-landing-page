      ...
      <div class="flex flex-col justify-between h-full max-w-3xl mx-auto">
        ...
        <div>
          ...
          <div class="w-full md:w-2/3 lg:w-1/2">
            <button
              class="flex justify-between w-full h-10 p-1 font-mono tracking-wide text-white uppercase bg-red-600 shadow-lg sm:h-12 sm:text-xl sm:w-1/2"
            >
    ...
    <section class="px-4 sm:px-8">
      <div class="max-w-3xl mx-auto">
        ...
        <ul class="space-y-4">
          ...
          >
            <div
              class="flex-none w-12 p-1 mt-1 text-center border border-black cursor-pointer border-red sm:w-24 hover:text-red-600 hover:border-red-600"
            >
              <p class="font-mono text-sm font-semibold uppercase sm:text-base">
